...
ThemeData::ThemeData(int nThemeFlags)
{
	if (nThemeFlags == THEME_BASIC)
	{
		...
		engineeringIcon = { IDB_PNG_ENGINEERING_NOMAL_THEME_BASIC, IDB_PNG_ENGINEERING_HOVER_THEME_BASIC, IDB_PNG_ENGINEERING_CLICK_THEME_BASIC };
		stopwatchIcon = { IDB_PNG_STOPWATCH_NOMAL_THEME_BASIC, IDB_PNG_STOPWATCH_HOVER_THEME_BASIC, IDB_PNG_STOPWATCH_CLICK_THEME_BASIC };
		converterIcon = { IDB_PNG_CONVERTER_NOMAL_THEME_BASIC, IDB_PNG_CONVERTER_HOVER_THEME_BASIC, IDB_PNG_CONVERTER_CLICK_THEME_BASIC };
		datecalIcon = { IDB_PNG_DATECAL_NOMAL_THEME_BASIC, IDB_PNG_DATECAL_HOVER_THEME_BASIC, IDB_PNG_DATECAL_CLICK_THEME_BASIC };
		worktimerIcon = { IDB_PNG_WORKTIMER_NOMAL_THEME_BASIC, IDB_PNG_WORKTIMER_HOVER_THEME_BASIC, IDB_PNG_WORKTIMER_CLICK_THEME_BASIC };
		notepadIcon = { IDB_PNG_NOTEPAD_NOMAL_THEME_BASIC, IDB_PNG_NOTEPAD_HOVER_THEME_BASIC, IDB_PNG_NOTEPAD_CLICK_THEME_BASIC };
		basetimerIcon = { IDB_PNG_BASETIMER_NOMAL_THEME_BASIC, IDB_PNG_BASETIMER_HOVER_THEME_BASIC, IDB_PNG_BASETIMER_CLICK_THEME_BASIC };
		worldclockIcon = { IDB_PNG_WORLDCLOCK_NOMAL_THEME_BASIC, IDB_PNG_WORLDCLOCK_HOVER_THEME_BASIC, IDB_PNG_WORLDCLOCK_CLICK_THEME_BASIC };
		scrollIcon = { IDB_PNG_SCROLL_NONSIGNAL_THEME_BASIC, IDB_PNG_SCROLL_SIGNAL_THEME_BASIC, IDB_PNG_SCROLL_NONSIGNAL_THEME_BASIC };
		commingSoonIcon = { IDB_PNG_COMINGSOON_THEME_BASIC, IDB_PNG_COMINGSOON_THEME_BASIC, IDB_PNG_COMINGSOON_THEME_BASIC };
		textColor = RGB(0, 0, 0);
		functionTextColor = RGB(255, 255, 255);
		functionBkColor = RGB(140, 148, 155);
		functionSubColor = RGB(0, 0, 0);
		rectBorderColor = RGB(255, 255, 255);
		functionRectBorderColor = RGB(140, 148, 155);
		buttonColor = RGB(50, 50, 50);
		nSettingThemeBkIconID = IDB_BITMAP_CHOICE_BK_THEME_BASIC;
		nMainBkIconID = IDB_BITMAP_MAIN_BK_THEME_BASIC;
	...
	else if (nThemeFlags == THEME_UTIL)
	{
		strThemeName = _T("유틸 테마");
		strThemeFontName = _T("가비아 솔미체");
		this->nThemeFlags = nThemeFlags;
		themeButtonIcon = { IDB_PNG_CHANGE_NOMAL_THEME_UTIL, IDB_PNG_CHANGE_HOVER_THEME_UTIL, IDB_PNG_CHANGE_CLICK_THEME_UTIL };
		baseIcon = { IDB_PNG_BASE_NOMAL_THEME_UTIL, IDB_PNG_BASE_HOVER_THEME_UTIL, IDB_PNG_BASE_CLICK_THEME_UTIL };
		engineeringIcon = { IDB_PNG_ENGINEERING_NOMAL_THEME_UTIL, IDB_PNG_ENGINEERING_HOVER_THEME_UTIL, IDB_PNG_ENGINEERING_CLICK_THEME_UTIL };
		stopwatchIcon = { IDB_PNG_STOPWATCH_NOMAL_THEME_UTIL, IDB_PNG_STOPWATCH_HOVER_THEME_UTIL, IDB_PNG_STOPWATCH_CLICK_THEME_UTIL };
		converterIcon = { IDB_PNG_CONVERTER_NOMAL_THEME_UTIL, IDB_PNG_CONVERTER_HOVER_THEME_UTIL, IDB_PNG_CONVERTER_CLICK_THEME_UTIL };
		datecalIcon = { IDB_PNG_DATECAL_NOMAL_THEME_UTIL, IDB_PNG_DATECAL_HOVER_THEME_UTIL, IDB_PNG_DATECAL_CLICK_THEME_UTIL };
		worktimerIcon = { IDB_PNG_WORKTIMER_NOMAL_THEME_UTIL, IDB_PNG_WORKTIMER_HOVER_THEME_UTIL, IDB_PNG_WORKTIMER_CLICK_THEME_UTIL };
		notepadIcon = { IDB_PNG_NOTEPAD_NOMAL_THEME_UTIL, IDB_PNG_NOTEPAD_HOVER_THEME_UTIL, IDB_PNG_NOTEPAD_CLICK_THEME_UTIL };
		basetimerIcon = { IDB_PNG_BASETIMER_NOMAL_THEME_UTIL, IDB_PNG_BASETIMER_HOVER_THEME_UTIL, IDB_PNG_BASETIMER_CLICK_THEME_UTIL };
		worldclockIcon = { IDB_PNG_WORLDCLOCK_NOMAL_THEME_UTIL, IDB_PNG_WORLDCLOCK_HOVER_THEME_UTIL, IDB_PNG_WORLDCLOCK_CLICK_THEME_UTIL };
		scrollIcon = { IDB_PNG_SCROLL_NONSIGNAL_THEME_UTIL, IDB_PNG_SCROLL_SIGNAL_THEME_UTIL, IDB_PNG_SCROLL_NONSIGNAL_THEME_UTIL };
		commingSoonIcon = { IDB_PNG_COMINGSOON_THEME_UTIL, IDB_PNG_COMINGSOON_THEME_UTIL, IDB_PNG_COMINGSOON_THEME_UTIL };
		textColor = RGB(0, 0, 0);
		functionTextColor = RGB(254, 202, 117);
		functionBkColor = RGB(254, 202, 117);
		functionSubColor = RGB(0, 0, 0);
		rectBorderColor = RGB(125, 125, 128);
		functionRectBorderColor = RGB(67, 68, 71);
		buttonColor = RGB(50, 50, 50);
		nSettingThemeBkIconID = IDB_BITMAP_CHOICE_BK_THEME_UTIL;
		nMainBkIconID = IDB_BITMAP_MAIN_BK_THEME_UTIL;
		nMainTimePosMargin = THEME_MAIN_TIME_POS_UP;
	}
}
