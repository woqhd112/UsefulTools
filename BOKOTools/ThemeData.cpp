...
ThemeData::ThemeData(int nThemeFlags)
{
	...
	baseIcon = { IDB_PNG_BASE_NOMAL_THEME_SEXY, IDB_PNG_BASE_HOVER_THEME_SEXY, IDB_PNG_BASE_CLICK_THEME_SEXY };
	engineeringIcon = { IDB_PNG_ENGINEERING_NOMAL_THEME_SEXY, IDB_PNG_ENGINEERING_HOVER_THEME_SEXY, IDB_PNG_ENGINEERING_CLICK_THEME_SEXY };
	stopwatchIcon = { IDB_PNG_STOPWATCH_NOMAL_THEME_SEXY, IDB_PNG_STOPWATCH_HOVER_THEME_SEXY, IDB_PNG_STOPWATCH_CLICK_THEME_SEXY };
	converterIcon = { IDB_PNG_CONVERTER_NOMAL_THEME_SEXY, IDB_PNG_CONVERTER_HOVER_THEME_SEXY, IDB_PNG_CONVERTER_CLICK_THEME_SEXY };
	datecalIcon = { IDB_PNG_DATECAL_NOMAL_THEME_SEXY, IDB_PNG_DATECAL_HOVER_THEME_SEXY, IDB_PNG_DATECAL_CLICK_THEME_SEXY };
	worktimerIcon = { IDB_PNG_WORKTIMER_NOMAL_THEME_SEXY, IDB_PNG_WORKTIMER_HOVER_THEME_SEXY, IDB_PNG_WORKTIMER_CLICK_THEME_SEXY };
	notepadIcon = { IDB_PNG_NOTEPAD_NOMAL_THEME_SEXY, IDB_PNG_NOTEPAD_HOVER_THEME_SEXY, IDB_PNG_NOTEPAD_CLICK_THEME_SEXY };
	basetimerIcon = { IDB_PNG_BASETIMER_NOMAL_THEME_SEXY, IDB_PNG_BASETIMER_HOVER_THEME_SEXY, IDB_PNG_BASETIMER_CLICK_THEME_SEXY };
	worldclockIcon = { IDB_PNG_WORLDCLOCK_NOMAL_THEME_SEXY, IDB_PNG_WORLDCLOCK_HOVER_THEME_SEXY, IDB_PNG_WORLDCLOCK_CLICK_THEME_SEXY };
	scrollIcon = { IDB_PNG_SCROLL_NONSIGNAL_THEME_SEXY, IDB_PNG_SCROLL_SIGNAL_THEME_SEXY, IDB_PNG_SCROLL_NONSIGNAL_THEME_SEXY };
	commingSoonIcon = { IDB_PNG_COMINGSOON_THEME_SEXY, IDB_PNG_COMINGSOON_THEME_SEXY, IDB_PNG_COMINGSOON_THEME_SEXY };
	textColor = RGB(255, 255, 255);
	functionTextColor = RGB(7, 7, 7);
	functionBkColor = RGB(7, 7, 7);
	functionSubColor = RGB(97, 97, 97);
	functionSubSubColor = RGB(255, 255, 255);
	rectBorderColor = RGB(255, 255, 255);
	functionRectBorderColor = RGB(7, 7, 7);
	buttonColor = RGB(115, 115, 115);
	nSettingThemeBkIconID = IDB_BITMAP_CHOICE_BK_THEME_SEXY;
	nMainBkIconID = IDB_BITMAP_MAIN_BK_THEME_SEXY;
	nMainTimePosMargin = THEME_MAIN_TIME_POS_UP;
	}
}
