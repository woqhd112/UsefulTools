...
Timer::Timer(int nManualImageID, bool bUsingManual, ThemeData* currentTheme, CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_DIALOG_TIMER, pParent)
{
	this->pParent = pParent;
	this->currentTheme = currentTheme;
	this->bUsingManual = bUsingManual;
	usingManual = new UsingManualDialog(true, IDD_DIALOG_TIMER, nManualImageID, currentTheme);
	nDivideMargin = 0;
	bDivideClick = false;
	//nBkBrightness = 0;
